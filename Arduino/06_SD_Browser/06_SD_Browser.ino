...
static void create_ui() {
  ...
  lv_obj_set_style_text_color(status_label, lv_color_hex(0x2563EB), 0);
  ...
  lv_obj_set_style_text_color(path_label, lv_color_hex(0x64748B), 0);
  ...
  lv_obj_set_style_text_color(card_label, lv_color_hex(0x64748B), 0);
  ...
  lv_obj_set_style_border_color(content_panel, lv_color_hex(0xCBD5E1), 0);
  lv_obj_set_style_bg_color(content_panel, lv_color_hex(0xFFFFFF), 0);
  ...
  lv_obj_set_style_text_color(content_label, lv_color_hex(0x0F172A), 0);
  ...
  lv_obj_set_style_text_color(footer_label, lv_color_hex(0x475569), 0);
...
static void render_error_view() {
  ...
  lv_obj_set_style_text_color(status_label, lv_color_hex(0xDC2626), 0);
...
static void render_preview_view() {
  ...
  lv_obj_set_style_text_color(status_label, lv_color_hex(0xB45309), 0);
