...
static const char *DEVICE_NAME = "ESP32S3 1.83inch";
...
static void create_ui() {
  ...
  lv_obj_set_style_text_color(count_label, lv_color_hex(0x64748b), 0);
  ...
  lv_label_set_text(device_label, "Name: ESP32S3 1.83inch");
  lv_obj_set_style_text_color(device_label, lv_color_hex(0x2563eb), 0);
  ...
  lv_obj_set_style_border_color(message_panel, lv_color_hex(0xcbd5e1), 0);
  lv_obj_set_style_bg_color(message_panel, lv_color_hex(0xffffff), 0);
  ...
  lv_obj_set_style_text_color(message_label, lv_color_hex(0x111827), 0);
  ...
  lv_obj_set_style_text_color(footer_label, lv_color_hex(0x64748b), 0);
...
static void init_ble_text_lab() {
  ...
  Serial.println("[BLE] Advertising as ESP32S3 1.83inch BLE Text");
}
