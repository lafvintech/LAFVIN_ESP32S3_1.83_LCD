/**********************************************************************
  ...
  IMU Pinout  : IMU_SDA/48 IMU_SCL/47 IMU_INT1/13 IMU_INT2/12
  LCD Pinout  : RES/39 SDA/45 SCL/40 CS/42 DC/41 BL/46
  Author      : OpenCode
...
void update_sensor_ui(void) {
  ...
  lv_obj_set_style_bg_color(status_led, lv_color_hex(0x00FF00), 0);
}

void create_ui(void) {
  label_title = lv_label_create(lv_scr_act());
  lv_obj_set_style_text_font(label_title, &lv_font_montserrat_16, 0);
  lv_obj_set_style_text_color(label_title, lv_color_hex(0x00D4AA), 0);
  ...
  lv_obj_set_style_text_color(label_acc, lv_color_hex(0xCCCCCC), 0);
  ...
  lv_obj_set_style_text_color(label_gyro, lv_color_hex(0xCCCCCC), 0);
  ...
  lv_obj_set_style_bg_color(bar_acc_x, lv_color_hex(0x333333), LV_PART_MAIN);
  lv_obj_set_style_bg_color(bar_acc_x, lv_color_hex(0xFF4444), LV_PART_INDICATOR);
  ...
  lv_obj_set_style_bg_color(bar_acc_y, lv_color_hex(0x333333), LV_PART_MAIN);
  lv_obj_set_style_bg_color(bar_acc_y, lv_color_hex(0x44FF44), LV_PART_INDICATOR);
  ...
  lv_obj_set_style_bg_color(bar_acc_z, lv_color_hex(0x333333), LV_PART_MAIN);
  lv_obj_set_style_bg_color(bar_acc_z, lv_color_hex(0x4444FF), LV_PART_INDICATOR);
  ...
  lv_obj_set_style_text_color(lbl_bar, lv_color_hex(0x888888), 0);
  ...
  lv_obj_set_style_bg_color(chart_acc, lv_color_hex(0x1A1A1A), 0);
  lv_obj_set_style_border_color(chart_acc, lv_color_hex(0x333333), 0);
  lv_obj_set_style_border_width(chart_acc, 1, 0);

  ser_acc_x = lv_chart_add_series(chart_acc, lv_color_hex(0xFF4444), LV_CHART_AXIS_PRIMARY_Y);
  ser_acc_y = lv_chart_add_series(chart_acc, lv_color_hex(0x44FF44), LV_CHART_AXIS_PRIMARY_Y);
  ser_acc_z = lv_chart_add_series(chart_acc, lv_color_hex(0x4444FF), LV_CHART_AXIS_PRIMARY_Y);
  ...
  lv_obj_set_style_bg_color(chart_gyro, lv_color_hex(0x1A1A1A), 0);
  lv_obj_set_style_border_color(chart_gyro, lv_color_hex(0x333333), 0);
  lv_obj_set_style_border_width(chart_gyro, 1, 0);

  ser_gyro_x = lv_chart_add_series(chart_gyro, lv_color_hex(0xFF4444), LV_CHART_AXIS_PRIMARY_Y);
  ser_gyro_y = lv_chart_add_series(chart_gyro, lv_color_hex(0x44FF44), LV_CHART_AXIS_PRIMARY_Y);
  ser_gyro_z = lv_chart_add_series(chart_gyro, lv_color_hex(0x4444FF), LV_CHART_AXIS_PRIMARY_Y);
}
